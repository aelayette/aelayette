...
- **Other:** Linux, Windows, Project Management
...
- **S.I.R.E Incident Response Simulator (In Progress)** – Capstone project (Node.js, Express, Socket.IO, React)
...
<!---
aelayette/aelayette is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
